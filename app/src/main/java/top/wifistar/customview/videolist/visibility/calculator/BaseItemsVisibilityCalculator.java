package top.wifistar.customview.videolist.visibility.calculator;

import android.widget.AbsListView;

import top.wifistar.customview.videolist.visibility.scroll.ItemsPositionGetter;
import top.wifistar.customview.videolist.visibility.scroll.ScrollDirectionDetector;


/**
 * This class encapsulates some basic logic of Visibility calculator.
 * In onScroll event it calculates Scroll direction using {@link com}
