...
import top.wifistar.bean.bmob.Crash;
...
//        autoClear(5);
    ...
    private void saveCrashInfoFile(Throwable ex) throws Exception {
        ...
        try {
            ...
            sb.append(result);
            uploadExceptionInfo(sb.toString());
        } catch (Exception e) {
            Log.e(TAG, "an error occured while writing file...", e);
            sb.append("an error occured while writing file...\r\n");
            uploadExceptionInfo(sb.toString() + e.getMessage());
        }
    }

    private void uploadExceptionInfo(String sb) throws Exception {
...
//    private String saveToFile(String sb) throws Exception {
//        String time = formatter.format(new Date());
