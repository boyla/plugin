...
import top.wifistar.adapter.viewholder.im.AgreeHolder;
import top.wifistar.adapter.viewholder.im.BaseViewHolder;
import top.wifistar.adapter.viewholder.im.OnRecyclerViewListener;
import top.wifistar.adapter.viewholder.im.ReceiveImageHolder;
import top.wifistar.adapter.viewholder.im.ReceiveLocationHolder;
import top.wifistar.adapter.viewholder.im.ReceiveTextHolder;
import top.wifistar.adapter.viewholder.im.ReceiveVideoHolder;
import top.wifistar.adapter.viewholder.im.ReceiveVoiceHolder;
import top.wifistar.adapter.viewholder.im.SendImageHolder;
import top.wifistar.adapter.viewholder.im.SendLocationHolder;
...
public class ChatMsgAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ChatMsgAdapter(Context context, BmobIMConversation c) {
        try {
            currentUid = Utils.getCurrentShortUser().getObjectId();
        } catch (Exception e) {
            e.printStackTrace();
        }
        this.c =c;
        BaseViewHolder.conversationIcon = c.getConversationIcon();
        BaseViewHolder.conversationId = c.getConversationId();
        BaseViewHolder.conversationName = c.getConversationTitle();
    }
