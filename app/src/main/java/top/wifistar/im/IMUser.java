...
import top.wifistar.rong.models.CheckOnlineReslut;
import top.wifistar.rong.models.CodeSuccessReslut;
import top.wifistar.rong.models.QueryBlacklistUserReslut;
import top.wifistar.rong.models.QueryBlockUserReslut;
import top.wifistar.rong.models.TokenReslut;
import top.wifistar.rong.util.GsonUtil;
import top.wifistar.rong.util.HostType;
import top.wifistar.rong.util.HttpUtil;
...
public class IMUser {
	...
	public IMUser(Context context) {
		this.username = Utils.decrypt(context.getResources().getString(R.string.app_name),context.getResources().getString(R.string.default_username));
		this.password = Utils.decrypt(context.getResources().getString(R.string.app_name),context.getResources().getString(R.string.default_password));
	}
	...
	public TokenReslut getToken(String userId, String name, String portraitUri) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, username, password, "/user/getToken.json", "application/x-www-form-urlencoded");
	...
	public CodeSuccessReslut refresh(String userId, String name, String portraitUri) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, username, password, "/user/refresh.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CheckOnlineReslut checkOnline(String userId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, username, password, "/user/checkOnline.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CodeSuccessReslut block(String userId, Integer minute) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, username, password, "/user/block.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CodeSuccessReslut unBlock(String userId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, username, password, "/user/unblock.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public QueryBlockUserReslut queryBlock() throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, username, password, "/user/block/query.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CodeSuccessReslut addBlacklist(String userId, String blackUserId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, username, password, "/user/blacklist/add.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public QueryBlacklistUserReslut queryBlacklist(String userId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, username, password, "/user/blacklist/query.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
	...
	public CodeSuccessReslut removeBlacklist(String userId, String blackUserId) throws Exception {
		...
		HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, username, password, "/user/blacklist/remove.json", "application/x-www-form-urlencoded");
		HttpUtil.setBodyParameter(body, conn);
